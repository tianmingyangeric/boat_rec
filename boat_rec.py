...
test_data, test_label = load_testing_file()
d = 20
training_pca = PCA_Algorithm(training_data,d)
testing_pca = PCA_Algorithm(test_data,d)
result, score = KNN_classifier(training_pca,training_label,testing_pca,test_label, 5)
print (result)
print (score)
